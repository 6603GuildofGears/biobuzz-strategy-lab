...
const ASSUMPTIONS = [
  ...
  "Shooting: a robot lines up once per trip (align time), then fires its whole load one element every launch time. A bump of more than 0.3 ft while shooting costs a quick correction (a quarter of the align time), and the next shot goes in 85% as often.",
