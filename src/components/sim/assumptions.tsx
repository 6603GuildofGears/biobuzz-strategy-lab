...
const ASSUMPTIONS = [
  ...
  "HIVE weight model: POLLEN = 1, NECTAR = 1.67 (slider), tip threshold 7.5 ± 0.35 (slider). A tipped CELL spins for about a second, then the balls pour out of that opening, bounce off each other, and roll across the field.",
