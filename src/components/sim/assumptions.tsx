...
const ASSUMPTIONS = [
  ...
  "Shots only score through the front opening of your HIVE, the face toward your alliance wall. Effective range is the shorter of the launcher's range and what its shot speed can carry, so a robot cannot sink a shot from the back of the field. Longer shots inside that range are less accurate. A miss bounces off the HIVE and rolls away. A missed FLOWER placement drops beside the FLOWER and rolls.",
